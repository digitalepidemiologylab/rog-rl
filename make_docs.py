...
for image_file in glob.glob(r'./docs/rog-rl*.rst'):
...
subprocess.call(['sphinx-apidoc', '--force', '-a', '-e', '-o', 'docs/', 'rog_rl', '-H', 'API Reference', '--tocfile',
                 '05_apidoc'])

os.environ["SPHINXPROJ"] = "rog-rl"
os.chdir('docs')

...
def build_server(grid_width=50, grid_height=50):
    ...
    canvas_element = CanvasGrid(
        agent_potrayal, grid_width, grid_height, canvas_width, canvas_height
    )
    chart_element = ChartModule(
        [
            ...
            {"Label": "R0/10", "Color": "rgb{}".format(COLOR_MAP.get_color("R0/10"))},
        ]
    )
    model_params = {
        "width": grid_width,
        ...
        "initial_infection_fraction": UserSettableParameter(
            "slider",
        ...
        "initial_vaccination_fraction": UserSettableParameter(
            "slider",
        ...
        "prob_infection": UserSettableParameter(
            "slider",
        ...
        "prob_agent_movement": UserSettableParameter(
            "slider",
        ...
        "early_stopping_patience": UserSettableParameter(
            "number", "Early Stopping Patience", value=14
        ),
